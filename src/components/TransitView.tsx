  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-4 py-3 sm:py-6 pb-44 sm:pb-36 md:pb-16 space-y-6">
      ...
      <div className="bg-gradient-to-br from-[#FAF2E8] via-[#F5ECE0] to-[#EFE2D2] border border-[#DECEBE] rounded-2xl p-4 sm:p-5 shadow-xs text-[#3D2619]">
        ...
        {/* Quick Link Buttons with 44px touch targets */}
        <div className="mt-4 pt-3 border-t border-[#DECEBE] flex flex-wrap items-center gap-2">
          ...
          <button
            onClick={openGVBApp}
            className="min-h-[44px] flex items-center gap-1.5 px-4 py-2 rounded-xl bg-white hover:bg-[#FAF4ED] text-[#4A3222] font-semibold text-xs border border-[#DECEBE] transition-colors shadow-xs active:scale-95"
          >
