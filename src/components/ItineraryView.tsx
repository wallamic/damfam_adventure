...
export const ItineraryView: React.FC<ItineraryViewProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-4 py-3 sm:py-5 pb-44 sm:pb-36 md:pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
        {/* Left Column: Day Summary & Basecamp Hub (Sticky on Desktop) */}
        <div className="lg:col-span-4 lg:sticky lg:top-20 space-y-4">
          {/* Selected Day Overview Card */}
          <div className="bg-[#FFFDF9] border border-[#EDE2D5] rounded-2xl p-4 sm:p-5 shadow-xs">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-2">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs px-2.5 py-1 rounded-full bg-[#EBF3E8] text-[#2F5229] border border-[#C5DCBF] flex items-center gap-1 font-semibold">
                  ...
                  Stroller: {currentDay.strollerComfortScore}
                </span>
              </div>
            </div>
          ...
          {/* Quick Basecamp Connection Card (Enhanced Desktop Glanceability) */}
          <div className="hidden lg:block bg-[#FAF2E8] border border-[#ECD9C5] rounded-2xl p-4 shadow-xs text-xs space-y-2.5">
            <div className="font-bold text-[#803816] flex items-center gap-1.5 font-serif text-sm">
              <Home className="w-4 h-4 text-[#C85A32]" />
              <span>Basecamp Transit Hub</span>
            </div>
            <p className="text-[#5C4535] leading-relaxed">
              Departing from <strong>Eendrachtstraat 13H</strong>. Ground floor entry enables seamless stroller rollout.
            </p>
            <div className="pt-2 border-t border-[#ECD9C5] text-[#7A6150] space-y-1.5">
              <div className="flex items-center justify-between">
                <span>Tram 4 (Lutmastraat):</span>
                <span className="font-bold text-[#2E1A0F]">3 min walk</span>
              </div>
              <div className="flex items-center justify-between">
                <span>Metro 52 (De Pijp):</span>
                <span className="font-bold text-[#2E1A0F]">7 min walk</span>
              </div>
              <div className="flex items-center justify-between">
                <span>Sarphatipark:</span>
                <span className="font-bold text-[#2F5229]">4 min walk</span>
              </div>
            </div>
          </div>
        </div>

        {/* Right Column: Stops Timeline & Basecamp Return */}
                    ...
                    <div className="flex items-start justify-between gap-2.5">
                      <div className="flex items-start gap-3 flex-1">
                        ...
                        <button
                          ...
                          className="min-h-[44px] min-w-[44px] flex items-center justify-center -ml-1.5 -mt-1.5 rounded-xl text-[#A89484] hover:text-[#C85A32] focus:outline-none transition-colors active:scale-90"
                      ...
                      {/* Actions: Direct Google Maps & App Map Buttons with 44px touch targets */}
                      <div className="flex items-center gap-1.5 flex-shrink-0">
                        <button
                          onClick={() => openGoogleMapsDirections(stop.placeName)}
                          className="min-h-[44px] flex items-center gap-1.5 text-xs px-3 py-2 rounded-xl bg-[#FAF4ED] hover:bg-[#F0E2D4] text-[#803816] border border-[#DECEBE] transition-colors font-semibold active:scale-95 shadow-2xs"
                        ...
                        {stop.coordinates && (
                          <button
                            ...
                            className="min-h-[44px] flex items-center gap-1.5 text-xs px-3 py-2 rounded-xl bg-[#FAF4ED] hover:bg-[#F0E2D4] text-[#4A3222] border border-[#DECEBE] transition-colors font-medium active:scale-95 shadow-2xs"
            ...
            <div className="pt-2 border-t border-[#DECEBE] flex items-center justify-between gap-2">
              {prevDay ? (
                <button
                  ...
                  className="min-h-[44px] flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-white hover:bg-[#FAF4ED] text-[#4A3222] border border-[#DECEBE] text-xs font-semibold transition-colors active:scale-95"
                >
              ...
              {nextDay ? (
                <button
                  ...
                  className="min-h-[44px] flex items-center gap-1.5 px-4.5 py-2 rounded-xl bg-[#C85A32] hover:bg-[#B34B24] text-white text-xs font-bold transition-colors active:scale-95 shadow-xs"
                >
